...
const Scouting = () => {
    return (
        ...
        <div className='flex flex-col flex-grow justify-center'>
            <div className='flex flex-row justify-around py-4 rounded-2xl'>
                <div className='bg-white rounded w-191 flex flex-col justify-center max-h-150'>
            ...
            <div className='flex flex-row justify-around py-8'>
                ...
                <div className='bg-white rounded px-14 py-3 w-200'>
